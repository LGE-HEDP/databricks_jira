...
df_result = spark.sql(f'''
    ...
    from   (
        ...
        where  1=1
            ...
            AND  mac_addr in (
            select distinct mac_addr
            from   sandbox.z_eunmi1_ko.temp_{p_normal_table}
    ...
    from   sandbox.z_eunmi1_ko.temp_{p_normal_table} as mart
...
df_result.coalesce(1).write.format("com.databricks.spark.csv").option("header", "true").save(f's3://s3-lge-he-inbound-aic-dev/HEDS/HEDS-1047/{p_pv}')
