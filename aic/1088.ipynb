...
df_result.coalesce(1).write.format("com.databricks.spark.csv").option("header", "true").save(f's3://s3-lge-he-inbound-aic-dev/HEDS/HEDS-1088/{p_pv}')
